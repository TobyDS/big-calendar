...
export function CalendarTimeline({ view }: { view: "week" | "day" }) {
  ...
  const shouldShow = view === "day" ? isSameDay(currentTime, selectedDate) : isSameWeek(currentTime, selectedDate, { weekStartsOn });
  ...
  return (
    ...
    >
      ...
      {view === "day" && <div className="absolute inset-x-0 border-t border-primary-600 dark:border-primary-700" />}
