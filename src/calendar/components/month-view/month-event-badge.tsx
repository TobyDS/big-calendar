  ...
  "mx-1 flex size-auto h-6.5 select-none items-center justify-between gap-1.5 truncate whitespace-nowrap rounded-md border px-2 text-xs transition-colors duration-200",
  {
    variants: {
      color: {
        ...
        indigo:
          "border-indigo-500/20 bg-indigo-500/10 text-indigo-500 hover:bg-indigo-500/20 dark:border-indigo-400/20 dark:bg-indigo-400/10 dark:text-indigo-400 dark:hover:bg-indigo-400/20",
        ...
        orange:
          "border-orange-500/20 bg-orange-500/10 text-orange-500 hover:bg-orange-500/20 dark:border-orange-400/20 dark:bg-orange-400/10 dark:text-orange-400 dark:hover:bg-orange-400/20",
        amber:
          "border-amber-500/20 bg-amber-500/10 text-amber-500 hover:bg-amber-500/20 dark:border-amber-400/20 dark:bg-amber-400/10 dark:text-amber-400 dark:hover:bg-amber-400/20",
        emerald:
          "border-emerald-500/20 bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500/20 dark:border-emerald-400/20 dark:bg-emerald-400/10 dark:text-emerald-400 dark:hover:bg-emerald-400/20",
...
export function MonthEventBadge({ event, cellDate, className }: { event: IEvent; cellDate: Date; className?: string }) {
  ...
  return (
    <div role="button" tabIndex={0} className={eventBadgeClasses} onClick={() => openEventDetailsDialog(event)}>
